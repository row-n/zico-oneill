...
function footer_scripts()
{
  if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
    // global $post;
    wp_register_script('zico-oneill', get_template_directory_uri() . '/script.js', array(), '2.0.1', true); // Custom scripts
...
function styles()
{
  wp_register_style('zico-oneill', get_template_directory_uri() . '/style.css', array(), '2.0.1', 'all');
