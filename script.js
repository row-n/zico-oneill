...
var Gallery = function Gallery(element) {
  ...
  var breakpoint = 768;
  var windowHeight = (0, _jquery2.default)(window).height() - 135;
  ...
  var showSlides = function showSlides() {
    ...
    setTimeout(function () {
      ...
      if (typeof _jquery2.default.fn.resizeImage === 'function') {
  ...
  var pageload = function pageload(hash) {
    if (hash) {
      _jquery2.default.galleriffic.gotoImage(hash);
    } else {
  ...
  (0, _jquery2.default)('a[rel=history]').on('click', function (event) {
    console.log(event);
    if (event.button !== 0) {
      return true;
    }
    ...
    _jquery2.default.historyLoad(hash);
  ...
  $thumbs.on('click', function (event) {
    ...
    (0, _jquery2.default)(event.target).parent().addClass('selected').siblings().removeClass('selected');
...
},{"../vendor/jquery.history":6,"./plugin":2,"galleriffic":5,"jquery":7}],2:[function(require,module,exports){
'use strict';
	...
	$.fn.galleriffic = function (settings) {
		...
		$.extend(this, {
			...
			buildImage: function buildImage(imageData, isSync) {
				...
				if (isSync) {
					...
					var newSlide = this.$imageContainer.append('<div class="slides__item current"><a class="slides__link" rel="history" href="#' + this.data[nextIndex].hash + '" title="' + imageData.title + '"></a></div>').find('div.current').css('opacity', '0');
				} else {

					//  *** photospace update - replace append with html to stop multiple images in fast clicks ***
					var newSlide = this.$imageContainer.html('<div class="slides__item current"><a class="slides__link" rel="history" href="#' + this.data[nextIndex].hash + '" title="' + imageData.title + '"></a></div>').find('div.current').css('opacity', '0');
				}
		...
		if (this.controlsContainerSel) {
			...
			if (this.renderNavControls) {
				this.$controlsContainer.append('<div class="nav-controls"><a class="prev" rel="history" title="' + this.prevLinkText + '"><span>' + this.prevLinkText + '</span></a><a class="next" rel="history" title="' + this.nextLinkText + '"><span>' + this.nextLinkText + '</span></a></div>').find('div.nav-controls a').click(function (e) {
					gallery.clickHandler(e, this);
				});
			}
		}
