...
var Gallery = function Gallery(element) {
  ...
  var $thumbnails = $element.find('#thumbnails');
  var $thumbs = $thumbnails.find('.thumbs__link');
  ...
  $thumbnails.galleriffic({
    ...
    onTransitionOut: function onTransitionOut(slide, caption, isSync, callback) {
    ...
    onTransitionIn: function onTransitionIn(slide, caption, isSync) {
    ...
    onPageTransitionOut: function onPageTransitionOut() {
      this.hide();
    },
  ...
  var showThumbs = function showThumbs() {
    $slideshow.fadeOut();
    setTimeout(function () {
      $thumbnails.fadeIn();
    }, 500);
  ...
  $thumbs.on('click', function (event) {
    ...
    if ((0, _jquery2.default)(window).innerWidth() <= tabletBreakpoint) {
...
(0, _plugin2.default)('Gallery', Gallery);

},{"./plugin":2,"galleriffic":5,"history":6,"jquery":7}],2:[function(require,module,exports){
'use strict';
...
(0, _plugin2.default)('Sidebar', Sidebar);

},{"./plugin":2,"jquery":7}],4:[function(require,module,exports){
'use strict';
...
(0, _jquery2.default)('#gallery').Gallery();
(0, _jquery2.default)('#sidebar').Sidebar();

},{"./plugins/gallery":1,"./plugins/sidebar":3,"jquery":7}],5:[function(require,module,exports){
(function (global){

; jQuery = global.jQuery = require("/Users/rowanparkinson/Sites/zico-oneill/wp-content/themes/zico-oneill/node_modules/jquery/dist/jquery.js");
...
;(function ($) {
	...
	$.galleriffic = {
		...
		normalizeHash: function normalizeHash(hash) {
		...
		gotoImage: function gotoImage(hash) {
		...
		removeImageByHash: function removeImageByHash(hash, ownerGallery) {
			var imageData = $.galleriffic.getImage(hash);
			if (!imageData) return false;
	...
	$.fn.galleriffic = function (settings) {
		...
		$.extend(this, {
			...
			clickHandler: function clickHandler(e, link) {
				this.pause();
			...
			appendImage: function appendImage(listItem) {
			...
			insertImage: function insertImage(listItem, position) {
			...
			// @param {Integer} position The index within the gallery where the item shouold be added.
			addImage: function addImage(listItem, thumbExists, insert, position) {
				...
				if (!thumbExists) {
					...
					this.updateThumbs(function () {
						...
						if (insert) $thumbsUl.children(':eq(' + position + ')').before($li);else $thumbsUl.append($li);
			...
			removeImageByIndex: function removeImageByIndex(index) {
			...
			removeImageByHash: function removeImageByHash(hash) {
				return $.galleriffic.removeImageByHash(hash, this);
			},

			// Removes an image from the gallery.
			removeImage: function removeImage(imageData) {
			...
			updateIndices: function updateIndices(startIndex) {
			...
			initializeThumbs: function initializeThumbs() {
				this.data = [];
				var gallery = this;
			...
			preloadInit: function preloadInit() {
			...
			preloadRelocate: function preloadRelocate(index) {
			...
			preloadRecursive: function preloadRecursive(startIndex, currentIndex) {
			...
			// @param {Integer} startIndex The index of the first image the current preloader started on.
			// @param {Integer} currentIndex The index of the current image to preload.
			preloadNext: function preloadNext(startIndex, currentIndex) {
			...
			toggleSlideshow: function toggleSlideshow() {
				if (this.isSlideshowRunning) this.pause();else this.play();
			...
			next: function next(dontPause, bypassHistory) {
			...
			// @param {Boolean} dontPause Specifies whether to pause the slideshow.
			// @param {Boolean} bypassHistory Specifies whether to delegate navigation to the history plugin when history is enabled.
			previous: function previous(dontPause, bypassHistory) {
			...
			// @param {Boolean} dontPause Specifies whether to pause the slideshow.
			// @param {Boolean} bypassHistory Specifies whether to delegate navigation to the history plugin when history is enabled.
			nextPage: function nextPage(dontPause, bypassHistory) {
			...
			// @param {Boolean} dontPause Specifies whether to pause the slideshow.
			// @param {Boolean} bypassHistory Specifies whether to delegate navigation to the history plugin when history is enabled.
			previousPage: function previousPage(dontPause, bypassHistory) {
				var page = this.getCurrentPage();
				if (page > 0) {
					var startIndex = page * this.numThumbs;
			...
			// @param {Boolean} dontPause Specifies whether to pause the slideshow.
			// @param {Boolean} bypassHistory Specifies whether to delegate navigation to the history plugin when history is enabled.
			gotoIndex: function gotoIndex(index, dontPause, bypassHistory) {
			...
			gotoImage: function gotoImage(imageData) {
				var index = imageData.index;
			...
			getDefaultTransitionDuration: function getDefaultTransitionDuration(isSync) {
			...
			refresh: function refresh() {
				...
				// Update Controls
				if (this.$controlsContainer) {
					this.$controlsContainer.find('div.controls__nav a.prev').attr('href', '#' + this.data[this.getPrevIndex(index)].hash).end().find('div.controls__nav a.next').attr('href', '#' + this.data[this.getNextIndex(index)].hash);
				}
				...
				var transitionOutCallback = function transitionOutCallback() {
			...
			// @param {Boolean} isSync Specifies whether the transitions are synchronized.
			buildImage: function buildImage(imageData, isSync) {
				var gallery = this;
				...
				if (isSync) {
					...
					var newSlide = this.$imageContainer.html('<span class="image-wrapper current"><a class="advance-link" rel="history" href="#' + this.data[nextIndex].hash + '" title="' + imageData.title + '">&nbsp;</a></span>').find('span.current').css('opacity', '0');
				}
			...
			syncThumbs: function syncThumbs() {
				var page = this.getCurrentPage();
			...
			updateThumbs: function updateThumbs(postTransitionOutHandler) {
				var gallery = this;
				var transitionOutCallback = function transitionOutCallback() {
					...
					if (gallery.onPageTransitionIn) gallery.onPageTransitionIn();else gallery.show();
				};
			...
			rebuildThumbs: function rebuildThumbs() {
				var needsPagination = this.data.length > this.numThumbs;

				// Rebuild top pager
				if (this.enableTopPager) {
					var $topPager = this.find('div.top');
					if ($topPager.length == 0) $topPager = this.prepend('<div class="top pagination"></div>').find('div.top');else $topPager.empty();
				...
				if (this.enableBottomPager) {
					...
					if ($bottomPager.length == 0) $bottomPager = this.append('<div class="bottom pagination"></div>').find('div.bottom');else $bottomPager.empty();
			...
			buildPager: function buildPager(pager) {
				var gallery = this;
			...
			buildPageLink: function buildPageLink(pager, pageNum, numPages) {
				var pageLabel = pageNum + 1;
				var currentPage = this.getCurrentPage();
				if (pageNum == currentPage) pager.append('<span class="current">' + pageLabel + '</span>');else if (pageNum < numPages) {
		...
		if (this.controlsContainerSel) {
			...
			if (this.renderSSControls) {
				if (this.autoStart) {
					this.$controlsContainer.append('<div class="ss-controls"><a href="#pause" class="pause" title="' + this.pauseLinkText + '"><span>' + this.pauseLinkText + '</span></a></div>');
				} else {
					this.$controlsContainer.append('<div class="ss-controls"><a href="#play" class="play" title="' + this.playLinkText + '"><span>' + this.playLinkText + '</span></a></div>');
				}
			...
			if (this.renderNavControls) {
				this.$controlsContainer.append('<div class="controls__nav"><a class="prev" rel="history" title="' + this.prevLinkText + '">' + this.prevLinkText + '</a><a class="next" rel="history" title="' + this.nextLinkText + '">' + this.nextLinkText + '</a></div>').find('div.controls__nav a').click(function (e) {
					gallery.clickHandler(e, this);
				});
			}
		}
...
},{"/Users/rowanparkinson/Sites/zico-oneill/wp-content/themes/zico-oneill/node_modules/jquery/dist/jquery.js":7}],6:[function(require,module,exports){
(function (global){
...
jQuery.extend({
    ...
    historyInit: function historyInit(callback, src) {
        ...
        if (current_hash) jQuery.historyCallback(current_hash.replace(/^#/, ''));
        setInterval(jQuery.historyCheck, 100);
    },

    historyAddHistory: function historyAddHistory(hash) {
    ...
    historyCheck: function historyCheck() {
        // if ((jQuery.browser.msie) && (jQuery.browser.version < 8)) {
        if (jQuery.browser.msie) {
...
},{"/Users/rowanparkinson/Sites/zico-oneill/wp-content/themes/zico-oneill/node_modules/jquery/dist/jquery.js":7}],7:[function(require,module,exports){
(function (global){
